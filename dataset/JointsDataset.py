...
class JointsDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # print(image_file, type(data_numpy))
        ...
        # print(data_numpy.shape, joints.shape, joints_vis.shape, c, s, score)

        # data_numpy = cv2.imread(image_file, cv2.IMREAD_COLOR | cv2.IMREAD_IGNORE_ORIENTATION)

        # print(image_file, data_numpy.shape)
        # print('joints',joints.shape, joints)
        # print('joint_vis',joints_vis.shape, joints_vis)
        # print(c,s,score)
        ...
        #     if joints_vis[k,0]:
        #         circle = mpatches.Circle(tuple(joints[k,:2]), 
        #                                  radius=radius, 
        #                                  ec='black', 
        #                                  fc=tuple(np.array((252,176,243))/255.), 
        #                                  alpha=1, 
        #                                  linewidth=1)
        #     circle.set_zorder(1)
        #     ax.add_patch(circle)
        ...
        # plt.margins(0,0)
        # plt.savefig('sample_posetrack.png', format='png', bbox_inckes='tight', dpi=100)
        # print('saved to sample_posetrack.png')
        # plt.close()
